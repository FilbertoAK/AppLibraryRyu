                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control" id="stock"
                                                                value="<?=$row['tanggal']?>" name="stock">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="stock" class="form-label">Stock</label>
                                                            <input type="number" class="form-control" id="stock"
                                                                value="<?=$row['masuk']?>" name="masuk">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="" method="POST">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Batal</button>
                                                        <button type="submit" name="deletestock"
            ...
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="simpanstock">Simpan Stock</button>
                    </div>
                </form>
            </div>
        </div>
